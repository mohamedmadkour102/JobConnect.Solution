...
#region اللي شغالة قبل البروقايل
//using JobConnect.Apis.DTO_s;
//using JobConnect.Apis.DTO_s.SeekerDto;
//using JobConnect.Apis.IRepository;
//using JobConnect.Apis.IService;
...
//        public async Task<IEnumerable<DTO_s.SeekerDto.JobDto>> GetAllJobsAsync()
//        {
//            var jobs = await _jobSeekerRepository.GetAllJobsAsync();

//            return await Task.WhenAll(jobs.Select(async job => new DTO_s.SeekerDto.JobDto
//            {
//                Id = job.Id,
//                Title = job.Title,
//                Status = job.Status,
...
//            return new DTO_s.SeekerDto.JobDto
//            {
//                Id = job.Id,
//                Title = job.Title,
//                Status = job.Status,
...
//        public async Task<(IEnumerable<DTO_s.SeekerDto.JobDto> Jobs, int TotalCount)> GetAllJobsPaginatedAsync(int pageNumber, int pageSize)
//        {
//            var (jobs, totalCount) = await _jobSeekerRepository.GetAllJobsPaginatedAsync(pageNumber, pageSize);

//            var jobDtos = await Task.WhenAll(jobs.Select(async job => new DTO_s.SeekerDto.JobDto
//            {
//                Id = job.Id,
//                Title = job.Title,
//                Status = job.Status,
